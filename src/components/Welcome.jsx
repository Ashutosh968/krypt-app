...
const Input = ({ placeholder, name, type, value, handleChange }) => (
    <input
        ...
        bg-transparent text-white border-none text-sm white-glassmorphism"
    />
);
...
const Welcome = () => {
    ...
    return (
        <div className="flex w-full justify-center items-center">
            <div className="flex mf:flex-row flex-col flex-start justify-between md:p-20 py-12 px-4">
